...
```json
{
  "slug": "asias-evolving-nexus-decoding-geopolitical-shifts-and-economic-trends-at-the-sco-summit",
  "date": "2024-08-01",
  "title": "Asia's Evolving Nexus: Decoding Geopolitical Shifts and Economic Trends at the SCO Summit",
  "description": "The recent Shanghai Cooperation Organisation (SCO) summit highlighted significant diplomatic engagements and economic trends shaping Asia, particularly between India, China, and Pakistan.",
